		...
		<section className="py-20 px-4">
			<div className="max-w-4xl mx-auto text-center">
				<motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="space-y-8">
					<h2 className="text-3xl font-bold text-gray-900">Prêt à construire la prochaine génération d&apos;applications mobiles ?</h2>
					<p className="text-gray-600 max-w-2xl mx-auto">
						Discutons de votre projet mobile. Ensemble, nous créerons une expérience utilisateur exceptionnelle qui marquera les esprits.
					</p>
					...
					<div className="flex flex-col sm:flex-row justify-center gap-4">
						<a
							href="mailto:denyok.emmanuel@gmail.com"
					...
					<div className="flex justify-center gap-6">
						...
						<a
							href="https://linkedin.com/in/denyokokou"
							target="_blank"
							rel="noopener noreferrer"
							className="text-gray-600 hover:text-gray-900 transition-colors p-2 hover:bg-gray-100 rounded-lg"
						>
